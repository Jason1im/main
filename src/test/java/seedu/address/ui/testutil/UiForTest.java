 ...
 */
public class UiForTest extends ComponentManager implements Ui {
    ...
    private static final Logger logger = LogsCenter.getLogger(seedu.address.ui.testutil.UiForTest.class);
    private static final String ICON_APPLICATION = "/images/address_book_32.png";

    private Logic logic;
    private Config config;
    private UserPrefs prefs;
    private MainWindowForTest mainWindow;

    public UiForTest(Logic logic, Config config, UserPrefs prefs) {
        super();
        this.logic = logic;
        this.config = config;
        this.prefs = prefs;
    ...
    public void start(Stage primaryStage) {
        ...
        try {
            //  /*
            mainWindow = new MainWindowForTest (primaryStage, config, prefs, logic);
